...
export class CalendarCommonPopover extends Component {
    static template = "sem_attendance.CalendarCommonPopover";
    static subTemplates = {
        popover: "sem_attendance.CalendarCommonPopover.popover",
        body: "sem_attendance.CalendarCommonPopover.body",
        footer: "sem_attendance.CalendarCommonPopover.footer",
    };
    static components = {
        Dialog,
        Field,
