...
export class CalendarFilterPanel extends Component {
    ...
    static template = "sem_attendance.CalendarFilterPanel";
    static subTemplates = {
        filter: "sem_attendance.CalendarFilterPanel.filter",
    };
    static props = {
        model: Object,
    };
    ...
    getFilterColor(filter) {
        return filter.colorIndex !== null ? "o_attendance_cw_filter_color_" + getColor(filter.colorIndex) : "";
    }
            ...
            sources: [
                {
                    ...
                    optionTemplate: "sem_attendance.CalendarFilterPanel.autocomplete.options",
                },
            ],
