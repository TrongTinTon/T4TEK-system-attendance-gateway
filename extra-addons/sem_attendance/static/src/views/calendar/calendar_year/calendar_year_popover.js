...
export class CalendarYearPopover extends Component {
    ...
    static template = "sem_attendance.CalendarYearPopover";
    static subTemplates = {
        popover: "sem_attendance.CalendarYearPopover.popover",
        body: "sem_attendance.CalendarYearPopover.body",
        footer: "sem_attendance.CalendarYearPopover.footer",
        record: "sem_attendance.CalendarYearPopover.record",
    };
    static props = {
        close: Function,
        date: true,
    ...
    getRecordClass(record) {
        ...
        if (color && typeof color === "number") {
            return `o_attendance_calendar_color_${color}`;
        }
        return "";
    }
